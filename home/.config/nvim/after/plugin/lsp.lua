...
-- Customize the LSP config for rust_analyzer specifically.
require 'lspconfig'.rust_analyzer.setup {
  settings = {
    ['rust-analyzer'] = {
      diagnostics = {
        -- This seems counter-intuitive, but the separate plugin `rust-tools handles diagnostics from the Rust Analyzer
        -- LSP, so it's disabled here.  This comes from the `rust-tools plugin docs.
        enable = false,
      }
    }
  }
